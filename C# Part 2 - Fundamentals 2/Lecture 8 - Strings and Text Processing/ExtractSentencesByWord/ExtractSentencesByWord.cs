...
class ExtractSentencesByWord
{
    static void Main()
    {
        string text = "We are living in a yellow submarine, yes we are! We don't have anything else. Inside the submarine is very tight." +
                    "So we are drinking all the day. We will move out of it in 5 days.";
        
        string word = "in";

        string pattern = String.Format(@"([\w\s,]*)(\b{0}\b)([\w\s,]*)([.!?]*)", word);
